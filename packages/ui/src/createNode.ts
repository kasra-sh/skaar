...
export function createComponentNode(type: Function | ComponentClass | Component, props?: JsObject, children?: (VNode | string | unknown)[]): Component | FnComponent {
   if (typeof type === 'function') {
      if (!type['_str']) {
         type['_str'] = type.toString();
      }
      if (type['_str'][0] === 'c') return createComponent(type as ComponentClass, props, children);
      else return cloneFnComponent(type, props, children);
   } else {
